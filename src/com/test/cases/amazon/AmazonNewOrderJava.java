...
public abstract class AmazonNewOrderJava {

	public AmazonNewOrderJava() {
	...
	public static void main(String[] args) throws Exception {
		...
		signin.clear();
		signin.sendKeys("example@email.com");
		...
		Thread.sleep(2000);
		Thread.sleep(2000);
		WebElement search=driver.findElement(By.id("twotabsearchtextbox"));//(".//*[@id='twotabsearchtextbox']"));
		search.clear();
